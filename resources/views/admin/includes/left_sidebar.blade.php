    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('admin.advertiser.index') }}">
                        <i class="icon" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Users"
                        ...
                        <span class="item-name">Advertiser</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('admin.category.index') }}">
                        <i class="icon" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Users"
                            data-bs-original-title="Users">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('admin.offer.index') }}">
                        <i class="icon">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('admin.affiliate.index') }}">
                        <i class="icon" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Users"
                            data-bs-original-title="Users">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('admin.manager.index') }}">
                        <i class="icon" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Users"
                            data-bs-original-title="Users">
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
