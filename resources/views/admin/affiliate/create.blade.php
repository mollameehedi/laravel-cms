                ...
                <nav aria-label="breadcrumb" class="d-flex justify-content-between pb-3">
                    <ol class="breadcrumb -0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.manager.index') }}"
                                class="breadcrumb-link">Affiliate</a></li>
                        <!---->
        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.affiliate.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select mb-3 shadow-none" name="manager_id">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" id="customFile" name="avatar">
                            </div>
