...
@section('content')
    <div class="content-inner container-fluid pb-0" id="page_layout">
        <div class="d-flex justify-content-between align-items-center flex-wrap mb-4 gap-3">
            ...
            <a href="{{ route('admin.manager.create') }}" class="btn btn-info">Create</a>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img class="rounded img-fluid avatar-65 me-3"
                                                    src="../../assets/images/table/1.png" alt="" loading="lazy" />
                                        ...
                                        <td class="text-dark">
                                            <svg width="18" class="me-2" viewBox="0 0 20 16" fill="none"
                                                ...
                                                <rect x="11.25" y="0.5" width="8.75" height="1.25"
                                                    fill="#DC251C" />
                                                <rect x="11.25" y="3" width="8.75" height="1.25"
                                                    fill="#DC251C" />
                                                <rect x="11.25" y="5.5" width="8.75" height="1.25"
                                                    fill="#DC251C" />
                                                <rect x="11.25" y="8" width="8.75" height="1.25"
                                                    fill="#DC251C" />
                                                <rect y="10.5" width="20" height="1.25" fill="#DC251C" />
                                                <rect y="13" width="20" height="1.25" fill="#DC251C" />
                                                <rect x="1.25" y="1.75" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="3.75" y="1.75" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="6.25" y="1.75" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="8.75" y="1.75" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="1.25" y="4.25" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="3.75" y="4.25" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="6.25" y="4.25" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="2.5" y="5.5" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="5" y="5.5" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="7.5" y="5.5" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="2.5" y="3" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="5" y="3" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="7.5" y="3" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="8.75" y="4.25" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="1.25" y="6.75" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="3.75" y="6.75" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="6.25" y="6.75" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                                <rect x="8.75" y="6.75" width="1.25" height="1.25"
                                                    fill="#C5D0EC" />
                                            </svg>
                                            USA
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img class="rounded img-fluid avatar-65 me-3"
                                                    src="../../assets/images/table/2.png" alt=""
                                                    loading="lazy" />
                                                <div class="media-support-info">
                                        ...
                                        <td class="text-dark">
                                            <svg width="18" class="me-2" viewBox="0 0 20 16" fill="none"
                                                ...
                                                <rect x="3.75" y="5.5" width="2.5" height="2.5"
                                                    fill="#DC251C" />
                                                ...
                                                <path d="M6.25 8H8.75V9.5C8.75 10.0523 8.30228 10.5 7.75 10.5H6.25V8Z"
                                                    fill="#DC251C" />
                                                <rect x="6.25" y="5.5" width="2.5" height="2.5"
                                                    fill="#A6A6A6" />
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img class="rounded img-fluid avatar-65 me-3"
                                                    src="../../assets/images/table/3.png" alt=""
                                                    loading="lazy" />
                                                <div class="media-support-info">
                                        ...
                                        <td class="text-dark">
                                            <svg width="18" class="me-2" viewBox="0 0 20 16" fill="none"
                                                ...
                                                <rect x="13.75" y="0.5" width="6.25" height="15"
                                                    fill="#DC251C" />
                                            </svg>
                                            ITL
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img class="rounded img-fluid avatar-65 me-3"
                                                    src="../../assets/images/table/4.png" alt=""
                                                    loading="lazy" />
                                                <div class="media-support-info">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img class="rounded img-fluid avatar-65 me-3"
                                                    src="../../assets/images/table/5.png" alt=""
                                                    loading="lazy" />
                                                <div class="media-support-info">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img class="rounded img-fluid avatar-65 me-3"
                                                    src="../../assets/images/table/6.png" alt=""
                                                    loading="lazy" />
                                                <div class="media-support-info">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img class="rounded img-fluid avatar-65 me-3"
                                                    src="../../assets/images/table/7.png" alt=""
                                                    loading="lazy" />
                                                <div class="media-support-info">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img class="rounded img-fluid avatar-65 me-3"
                                                    src="../../assets/images/table/8.png" alt=""
                                                    loading="lazy" />
                                                <div class="media-support-info">
                                                    <h5 class="iq-sub-label">Elon Musk</h5>
                                                    <p class="mb-0">@musk</p>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img class="rounded img-fluid avatar-65 me-3"
                                                    src="../../assets/images/table/9.png" alt=""
                                                    loading="lazy" />
                                                <div class="media-support-info">
                                                    <h5 class="iq-sub-label">Elon Musk</h5>
                                                    <p class="mb-0">@musk</p>
                                        ...
                                        <td class="text-dark">
                                            <svg width="18" class="me-2" viewBox="0 0 21 16" fill="none"
                                                ...
                                                <ellipse cx="10.5" cy="7.69231" rx="3.5" ry="3.69231"
                                                    fill="#DC251C" />
                                                <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="7"
                                                    y="7" width="7" height="5">
                                                    <path
